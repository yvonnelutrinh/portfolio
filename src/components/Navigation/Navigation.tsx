            ...
            >
              {routes.map((route, index) => (
                ...
                >
                  <Link
                    to={route.path}
                    className={`font-display text-6xl md:text-8xl tracking-wider hover:text-gray-400 transition-colors duration-300 ${
                      pathname === route.path ? "text-white" : "text-gray-600"
                    }`}
